...
#Tess an Virtual Assistant, group project by Harsh B [PearlsKing]. #true code2063

def respond(voice_data):
    # 1: greeting
    if there_exists(['hey', 'hi', 'hello', 'hai','yo','Tess']):
        greetings = ["hey, how can i help out" + person_obj.name, "Hey, what's up?" + person_obj.name, "I'm all ears" + person_obj.name, "How can i help you?" + person_obj.name, "Hello" + person_obj.name]
    ...
    if there_exists(["what's your name", "what is your name", "Tell us your name", "what should i call you", "tell me your name"]):
        if person_obj.name:
            ...
            engine_speak("Hey their, I am Tess, Pleasure meeting you")
    ...
    if there_exists(["your name should be"]):
        ...
        engine_speak("i have a name, Tess. but i will remember that name " + asis_name)
    ...
    # search for music
    if there_exists(["on spotify"]):
        search_term = voice_data.split("on spotify")[-1]
    ...
    if there_exists(["definition of"]):
        ...
        if definitions:
            ...
            engine_speak("im sorry i could not find the definition for " + definition) #truecode2063
